        ...
        for year in range(start_year+4, end_year):
            ...
            if np.isnan(fetch_data(row, year, 5, None, 'GP')) or np.isnan(fetch_data(row, year, 4, None, 'GP')) or np.isnan(fetch_data(row, year, 3, None, 'GP')) or np.isnan(fetch_data(row, year, 2, None, 'GP')):
                ...
                instance_df.loc[f"{row['Player']} {year+1}"] = [
                    ...
                    fetch_data(row, year, 2, 'ev', 'G/60')*fetch_data(row, year, 2, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pp', 'G/60')*fetch_data(row, year, 2, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pk', 'G/60')*fetch_data(row, year, 2, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 3, 'ev', 'G/60')*fetch_data(row, year, 3, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pp', 'G/60')*fetch_data(row, year, 3, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pk', 'G/60')*fetch_data(row, year, 3, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 4, 'ev', 'G/60')*fetch_data(row, year, 4, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pp', 'G/60')*fetch_data(row, year, 4, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pk', 'G/60')*fetch_data(row, year, 4, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 5, 'ev', 'G/60')*fetch_data(row, year, 5, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pp', 'G/60')*fetch_data(row, year, 5, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pk', 'G/60')*fetch_data(row, year, 5, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 1, 'ev', 'G/60')*fetch_data(row, year, 1, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 1, 'pp', 'G/60')*fetch_data(row, year, 1, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 1, 'pk', 'G/60')*fetch_data(row, year, 1, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 1, 'ev', 'A1/60')*fetch_data(row, year, 1, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 1, 'pp', 'A1/60')*fetch_data(row, year, 1, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 1, 'pk', 'A1/60')*fetch_data(row, year, 1, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 1, 'ev', 'A2/60')*fetch_data(row, year, 1, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 1, 'pp', 'A2/60')*fetch_data(row, year, 1, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 1, 'pk', 'A2/60')*fetch_data(row, year, 1, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 2, 'ev', 'G/60')*fetch_data(row, year, 2, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pp', 'G/60')*fetch_data(row, year, 2, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pk', 'G/60')*fetch_data(row, year, 2, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 2, 'ev', 'A1/60')*fetch_data(row, year, 2, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pp', 'A1/60')*fetch_data(row, year, 2, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pk', 'A1/60')*fetch_data(row, year, 2, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 2, 'ev', 'A2/60')*fetch_data(row, year, 2, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pp', 'A2/60')*fetch_data(row, year, 2, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 2, 'pk', 'A2/60')*fetch_data(row, year, 2, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 3, 'ev', 'G/60')*fetch_data(row, year, 3, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pp', 'G/60')*fetch_data(row, year, 3, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pk', 'G/60')*fetch_data(row, year, 3, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 3, 'ev', 'A1/60')*fetch_data(row, year, 3, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pp', 'A1/60')*fetch_data(row, year, 3, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pk', 'A1/60')*fetch_data(row, year, 3, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 3, 'ev', 'A2/60')*fetch_data(row, year, 3, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pp', 'A2/60')*fetch_data(row, year, 3, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 3, 'pk', 'A2/60')*fetch_data(row, year, 3, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 4, 'ev', 'G/60')*fetch_data(row, year, 4, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pp', 'G/60')*fetch_data(row, year, 4, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pk', 'G/60')*fetch_data(row, year, 4, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 4, 'ev', 'A1/60')*fetch_data(row, year, 4, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pp', 'A1/60')*fetch_data(row, year, 4, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pk', 'A1/60')*fetch_data(row, year, 4, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 4, 'ev', 'A2/60')*fetch_data(row, year, 4, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pp', 'A2/60')*fetch_data(row, year, 4, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 4, 'pk', 'A2/60')*fetch_data(row, year, 4, 'pk', 'ATOI')/60*82,
                    fetch_data(row, year, 5, 'ev', 'G/60')*fetch_data(row, year, 5, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pp', 'G/60')*fetch_data(row, year, 5, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pk', 'G/60')*fetch_data(row, year, 5, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 5, 'ev', 'A1/60')*fetch_data(row, year, 5, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pp', 'A1/60')*fetch_data(row, year, 5, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pk', 'A1/60')*fetch_data(row, year, 5, 'pk', 'ATOI')/60*82 + fetch_data(row, year, 5, 'ev', 'A2/60')*fetch_data(row, year, 5, 'ev', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pp', 'A2/60')*fetch_data(row, year, 5, 'pp', 'ATOI')/60*82 + fetch_data(row, year, 5, 'pk', 'A2/60')*fetch_data(row, year, 5, 'pk', 'ATOI')/60*82
                ]
