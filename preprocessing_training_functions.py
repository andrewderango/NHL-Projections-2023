            ...
            if dependent_variable == 'forward_GP':
                ...
                if row['Position'] == 'D':
                    ...
                    instance_df.loc[f"{row['Player']} {year+1}"] = [
                        ...
                        (fetch_data(row, year, 1, 'ev', 'G/60')+fetch_data(row, year, 1, 'ev', 'A1/60')+fetch_data(row, year, 1, 'ev', 'A2/60'))*fetch_data(row, year, 1, 'ev', 'ATOI') + (fetch_data(row, year, 1, 'pp', 'G/60')+fetch_data(row, year, 1, 'pp', 'A1/60')+fetch_data(row, year, 1, 'pp', 'A2/60'))*fetch_data(row, year, 1, 'pp', 'ATOI'),
                        (fetch_data(row, year, 2, 'ev', 'G/60')+fetch_data(row, year, 2, 'ev', 'A1/60')+fetch_data(row, year, 2, 'ev', 'A2/60'))*fetch_data(row, year, 2, 'ev', 'ATOI') + (fetch_data(row, year, 2, 'pp', 'G/60')+fetch_data(row, year, 2, 'pp', 'A1/60')+fetch_data(row, year, 2, 'pp', 'A2/60'))*fetch_data(row, year, 2, 'pp', 'ATOI'),
                        (fetch_data(row, year, 3, 'ev', 'G/60')+fetch_data(row, year, 3, 'ev', 'A1/60')+fetch_data(row, year, 3, 'ev', 'A2/60'))*fetch_data(row, year, 3, 'ev', 'ATOI') + (fetch_data(row, year, 3, 'pp', 'G/60')+fetch_data(row, year, 3, 'pp', 'A1/60')+fetch_data(row, year, 3, 'pp', 'A2/60'))*fetch_data(row, year, 3, 'pp', 'ATOI'),
                        (fetch_data(row, year, 4, 'ev', 'G/60')+fetch_data(row, year, 4, 'ev', 'A1/60')+fetch_data(row, year, 4, 'ev', 'A2/60'))*fetch_data(row, year, 4, 'ev', 'ATOI') + (fetch_data(row, year, 4, 'pp', 'G/60')+fetch_data(row, year, 4, 'pp', 'A1/60')+fetch_data(row, year, 4, 'pp', 'A2/60'))*fetch_data(row, year, 4, 'pp', 'ATOI')
                    ]
...
def create_year_restricted_instance_df(proj_stat, position, prev_years, situation, year=2023, download_file=True):
    if proj_stat == 'GP':
        instance_df = create_instance_df(f'{position}_GP', ['Player', 'Year', 'Position', 'Age', 'Height', 'Weight', 'Y1 GP', 'Y2 GP', 'Y3 GP', 'Y4 GP', 'Y5 GP', 'Y5 dGP', 'Y1 PTS/60GP', 'Y2 PTS/60GP', 'Y3 PTS/60GP', 'Y4 PTS/60GP'], scrape_player_statistics(True), True)
        if prev_years == 4:
    ...
    if proj_stat == 'GP':
        if prev_years == 4:
            for index, row in instance_df.iterrows():
                X.append([row['Age'], row['Height'], row['Weight'], row['Y1 GP'], row['Y2 GP'], row['Y3 GP'], row['Y4 GP'], row['Y1 PTS/60GP'], row['Y2 PTS/60GP'], row['Y3 PTS/60GP'], row['Y4 PTS/60GP']]) # features
                y.append(row['Y5 dGP']) # target
        elif prev_years == 3:
            for index, row in instance_df.iterrows():
                X.append([row['Age'], row['Height'], row['Weight'], row['Y2 GP'], row['Y3 GP'], row['Y4 GP'], row['Y2 PTS/60GP'], row['Y3 PTS/60GP'], row['Y4 PTS/60GP']]) # features
                y.append(row['Y5 dGP']) # target
        elif prev_years == 2:
            for index, row in instance_df.iterrows():
                X.append([row['Age'], row['Height'], row['Weight'], row['Y3 GP'], row['Y4 GP'], row['Y3 PTS/60GP'], row['Y4 PTS/60GP']]) # features
                y.append(row['Y5 dGP']) # target
        elif prev_years == 1:
            for index, row in instance_df.iterrows():
                X.append([row['Age'], row['Height'], row['Weight'], row['Y4 GP'], row['Y4 PTS/60GP']]) # features
                y.append(row['Y5 dGP']) # target
        else:
            print('Invalid prev_years parameter.')
...
def make_forward_gp_projections(stat_df, projection_df, download_file, year=2024):
    ...
    for player in yr4_group:
        yr4_stat_list.append([
            ...
            (stat_df.loc[stat_df['Player'] == player, f'{year-4} EV G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-4} EV A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-4} EV A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-4} EV ATOI'].fillna(0).iloc[0] + (stat_df.loc[stat_df['Player'] == player, f'{year-4} PP G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-4} PP A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-4} PP A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-4} PP ATOI'].fillna(0).iloc[0],
            (stat_df.loc[stat_df['Player'] == player, f'{year-3} EV G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-3} EV A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-3} EV A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-3} EV ATOI'].fillna(0).iloc[0] + (stat_df.loc[stat_df['Player'] == player, f'{year-3} PP G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-3} PP A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-3} PP A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-3} PP ATOI'].fillna(0).iloc[0],
            (stat_df.loc[stat_df['Player'] == player, f'{year-2} EV G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-2} EV A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-2} EV A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-2} EV ATOI'].fillna(0).iloc[0] + (stat_df.loc[stat_df['Player'] == player, f'{year-2} PP G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-2} PP A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-2} PP A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-2} PP ATOI'].fillna(0).iloc[0],
            (stat_df.loc[stat_df['Player'] == player, f'{year-1} EV G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-1} EV A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-1} EV A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-1} EV ATOI'].fillna(0).iloc[0] + (stat_df.loc[stat_df['Player'] == player, f'{year-1} PP G/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-1} PP A1/60'].fillna(0).iloc[0]+stat_df.loc[stat_df['Player'] == player, f'{year-1} PP A2/60'].fillna(0).iloc[0])*stat_df.loc[stat_df['Player'] == player, f'{year-1} PP ATOI'].fillna(0).iloc[0]])
    ...
    for index, statline in enumerate(yr4_stat_list):
        ...
        projection = min(proj_y_4[index][0] + statistics.mean(statline[3:7]), 82)
    ...
    for index, statline in enumerate(yr3_stat_list):
        ...
        projection = min(proj_y_3[index][0] + statistics.mean(statline[3:6]), 82)
    ...
    for index, statline in enumerate(yr2_stat_list):
        ...
        projection = min(proj_y_2[index][0] + statistics.mean(statline[3:5]), 82)
    ...
    for index, statline in enumerate(yr1_stat_list):
        ...
        projection = min(proj_y_1[index][0] + statistics.mean(statline[3:4]), 82) # watch year yrN
...
def make_defence_ev_a1per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A1per60', 'defence', 4, 'EV')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A1per60', 4, 'EV', 'defence')
    instance_df_y3, _ = create_year_restricted_instance_df('A1per60', 'defence', 3, 'EV')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A1per60', 3, 'EV', 'defence')
    instance_df_y2, _ = create_year_restricted_instance_df('A1per60', 'defence', 2, 'EV')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A1per60', 2, 'EV', 'defence')
    instance_df_y1, _ = create_year_restricted_instance_df('A1per60', 'defence', 1, 'EV')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A1per60', 1, 'EV', 'defence')
...
def make_forward_pp_a1per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A1per60', 'forward', 4, 'PP')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A1per60', 4, 'PP', 'forward')
    instance_df_y3, _ = create_year_restricted_instance_df('A1per60', 'forward', 3, 'PP')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A1per60', 3, 'PP', 'forward')
    instance_df_y2, _ = create_year_restricted_instance_df('A1per60', 'forward', 2, 'PP')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A1per60', 2, 'PP', 'forward')
    instance_df_y1, _ = create_year_restricted_instance_df('A1per60', 'forward', 1, 'PP')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A1per60', 1, 'PP', 'forward')
...
def make_defence_pp_a1per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A1per60', 'defence', 4, 'PP')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A1per60', 4, 'PP', 'defence')
    instance_df_y3, _ = create_year_restricted_instance_df('A1per60', 'defence', 3, 'PP')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A1per60', 3, 'PP', 'defence')
    instance_df_y2, _ = create_year_restricted_instance_df('A1per60', 'defence', 2, 'PP')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A1per60', 2, 'PP', 'defence')
    instance_df_y1, _ = create_year_restricted_instance_df('A1per60', 'defence', 1, 'PP')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A1per60', 1, 'PP', 'defence')
...
def make_forward_pk_a1per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A1per60', 'forward', 4, 'PK')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A1per60', 4, 'PK', 'forward')
    instance_df_y3, _ = create_year_restricted_instance_df('A1per60', 'forward', 3, 'PK')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A1per60', 3, 'PK', 'forward')
    instance_df_y2, _ = create_year_restricted_instance_df('A1per60', 'forward', 2, 'PK')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A1per60', 2, 'PK', 'forward')
    instance_df_y1, _ = create_year_restricted_instance_df('A1per60', 'forward', 1, 'PK')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A1per60', 1, 'PK', 'forward')
...
def make_defence_pk_a1per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A1per60', 'defence', 4, 'PK')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A1per60', 4, 'PK', 'defence')
    instance_df_y3, _ = create_year_restricted_instance_df('A1per60', 'defence', 3, 'PK')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A1per60', 3, 'PK', 'defence')
    instance_df_y2, _ = create_year_restricted_instance_df('A1per60', 'defence', 2, 'PK')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A1per60', 2, 'PK', 'defence')
    instance_df_y1, _ = create_year_restricted_instance_df('A1per60', 'defence', 1, 'PK')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A1per60', 1, 'PK', 'defence')
...
def make_forward_ev_a2per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A2per60', 'forward', 4, 'EV')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A2per60', 4, 'EV', 'forward')
    instance_df_y3, _ = create_year_restricted_instance_df('A2per60', 'forward', 3, 'EV')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A2per60', 3, 'EV', 'forward')
    instance_df_y2, _ = create_year_restricted_instance_df('A2per60', 'forward', 2, 'EV')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A2per60', 2, 'EV', 'forward')
    instance_df_y1, _ = create_year_restricted_instance_df('A2per60', 'forward', 1, 'EV')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A2per60', 1, 'EV', 'forward')
...
def make_defence_ev_a2per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A2per60', 'defence', 4, 'EV')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A2per60', 4, 'EV', 'defence')
    instance_df_y3, _ = create_year_restricted_instance_df('A2per60', 'defence', 3, 'EV')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A2per60', 3, 'EV', 'defence')
    instance_df_y2, _ = create_year_restricted_instance_df('A2per60', 'defence', 2, 'EV')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A2per60', 2, 'EV', 'defence')
    instance_df_y1, _ = create_year_restricted_instance_df('A2per60', 'defence', 1, 'EV')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A2per60', 1, 'EV', 'defence')
...
def make_forward_pp_a2per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A2per60', 'forward', 4, 'PP')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A2per60', 4, 'PP', 'forward')
    instance_df_y3, _ = create_year_restricted_instance_df('A2per60', 'forward', 3, 'PP')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A2per60', 3, 'PP', 'forward')
    instance_df_y2, _ = create_year_restricted_instance_df('A2per60', 'forward', 2, 'PP')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A2per60', 2, 'PP', 'forward')
    instance_df_y1, _ = create_year_restricted_instance_df('A2per60', 'forward', 1, 'PP')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A2per60', 1, 'PP', 'forward')
...
def make_defence_pp_a2per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A2per60', 'defence', 4, 'PP')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A2per60', 4, 'PP', 'defence')
    instance_df_y3, _ = create_year_restricted_instance_df('A2per60', 'defence', 3, 'PP')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A2per60', 3, 'PP', 'defence')
    instance_df_y2, _ = create_year_restricted_instance_df('A2per60', 'defence', 2, 'PP')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A2per60', 2, 'PP', 'defence')
    instance_df_y1, _ = create_year_restricted_instance_df('A2per60', 'defence', 1, 'PP')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A2per60', 1, 'PP', 'defence')
...
def make_forward_pk_a2per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A2per60', 'forward', 4, 'PK')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A2per60', 4, 'PK', 'forward')
    instance_df_y3, _ = create_year_restricted_instance_df('A2per60', 'forward', 3, 'PK')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A2per60', 3, 'PK', 'forward')
    instance_df_y2, _ = create_year_restricted_instance_df('A2per60', 'forward', 2, 'PK')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A2per60', 2, 'PK', 'forward')
    instance_df_y1, _ = create_year_restricted_instance_df('A2per60', 'forward', 1, 'PK')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A2per60', 1, 'PK', 'forward')
...
def make_defence_pk_a2per60_projections(stat_df, projection_df, download_file, year=2024):
    ...
    instance_df_y4, _ = create_year_restricted_instance_df('A2per60', 'defence', 4, 'PK')
    X_4, y_4 = extract_instance_data(instance_df_y4, 'A2per60', 4, 'PK', 'defence')
    instance_df_y3, _ = create_year_restricted_instance_df('A2per60', 'defence', 3, 'PK')
    X_3, y_3 = extract_instance_data(instance_df_y3, 'A2per60', 3, 'PK', 'defence')
    instance_df_y2, _ = create_year_restricted_instance_df('A2per60', 'defence', 2, 'PK')
    X_2, y_2 = extract_instance_data(instance_df_y2, 'A2per60', 2, 'PK', 'defence')
    instance_df_y1, _ = create_year_restricted_instance_df('A2per60', 'defence', 1, 'PK')
    X_1, y_1 = extract_instance_data(instance_df_y1, 'A2per60', 1, 'PK', 'defence')
...
def main():
    ...
    print(projection_df[['Player', 'Age', 'Height', 'Weight', 'GP']].to_string())
    # print(projection_df.to_string())
    # print(projection_df)
