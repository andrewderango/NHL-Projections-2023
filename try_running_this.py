...
# stat_df = prune_bios(player_bio_df) (ON)
# if you want to add more statistics for all situations to update stat_df, run:
# stat_df = scrape_statistics(stat_df, 'ev', 'std', True) (ON)
# stat_df = scrape_statistics(stat_df, 'pp', 'std', True) (ON)
# stat_df = scrape_statistics(stat_df, 'pk', 'std', True) (ON)
